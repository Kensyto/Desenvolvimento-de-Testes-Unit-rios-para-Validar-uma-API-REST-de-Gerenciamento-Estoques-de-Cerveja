...
public class BeerControllerTest {
    ...
    private static final String BEER_API_QUERY_PATH = "/api/v1/beers";
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockUnderZeroException.class);
