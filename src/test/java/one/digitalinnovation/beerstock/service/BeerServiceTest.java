...
import one.digitalinnovation.beerstock.exception.BeerStockUnderZeroException;
...
public class BeerServiceTest {
    ...
    @Test
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerStockUnderZeroException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenDecrementIsCalledToEmptyStockThenDecrementBeerStock() throws BeerNotFoundException, BeerStockUnderZeroException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    void whenDecrementIsLowerThanZeroThenThrowException() {
        ...
        assertThrows(BeerStockUnderZeroException.class, () -> beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement));
    }
